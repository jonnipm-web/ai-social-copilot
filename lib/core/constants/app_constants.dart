class AppConstants {
  ...
  static const routeMarketIntelligenceCompetitors =
      '/market-intelligence/competitors/:id';
  static const routeMarketIntelligenceGaps = '/market-intelligence/gaps/:id';
  static const routeMarketIntelligenceOpportunities =
      '/market-intelligence/opportunities/:id';
  static const routeMarketIntelligenceNiches =
      '/market-intelligence/niches/:id';
  static const routeMarketIntelligenceCluster =
      '/market-intelligence/content-cluster/:id';
  static const routeMarketIntelligenceRevenue =
      '/market-intelligence/revenue/:id';
  ...
  static const edgeFunctionGenerateOpportunities =
