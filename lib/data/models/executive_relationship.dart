...
class ExecutiveRelationship {
  ...
  String get typeEmoji {
    switch (type) {
      case RelationshipType.sharedNiche:    return '🎯';
      case RelationshipType.sharedAudience: return '👥';
      case RelationshipType.complementary:  return '🤝';
      case RelationshipType.conflicting:    return '⚔️';
      case RelationshipType.synergistic:    return '⚡';
      case RelationshipType.duplicate:      return '⚠️';
    }
  }

  String get typeLabel {
    switch (type) {
      case RelationshipType.sharedNiche:    return 'Nicho Compartilhado';
      case RelationshipType.sharedAudience: return 'Público Compartilhado';
      case RelationshipType.complementary:  return 'Complementares';
      case RelationshipType.conflicting:    return 'Conflitantes';
      case RelationshipType.synergistic:    return 'Sinérgicos';
      case RelationshipType.duplicate:      return 'Possível Duplicata';
    }
  }
