...
class _OpportunityDiscoveryScreenState
  ...
  Future<void> _discover() async {
    ...
    try {
      ...
      await ref.read(marketAnalysisServiceProvider).discoverOpportunities(
          widget.analysisId, analysis.input,
          context: ctx);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF0F0F1A),
        title:
            const Text('Oportunidades', style: TextStyle(color: Colors.white)),
            ...
            icon: _running
                ? const SizedBox(
                    ...
                    child: CircularProgressIndicator(
                        color: Color(0xFF6BCB77), strokeWidth: 2),
                  )
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text('Nenhuma oportunidade ainda',
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _MiniScore(
                  label: 'Dificuldade',
                  value: opportunity.difficultyScore,
