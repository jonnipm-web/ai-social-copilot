...
export const CLASS_LABEL: Readonly<Record<EpistemicClass, Readonly<Record<Lang, string>>>> = {
  ...
  // Neutral: the platform reports that a THIRD PARTY asserts something; it never accuses (Codex I4G3-03).
  ALLEGATION: { pt: 'Afirmação de terceiro, não estabelecida', en: 'Third-party assertion, not established' },
