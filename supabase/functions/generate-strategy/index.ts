...
export async function handler(
  ...
  // decides whether this caller may use 'strategy-generation'. Runs after authentication
  // and before any quota reservation or AI call. Fails closed.
  const access = await requireModuleAccess(req, authUser, 'strategy-generation', corsHeaders, subjectSource);
